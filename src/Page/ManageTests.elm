...
import Browser
import Http
import Json.Decode as Decode exposing (Decoder, int, string, list, nullable)
import Json.Decode.Pipeline exposing (required, optional, hardcoded)
import Html exposing (Html, div, text, h1, tbody, th, td, tr, thead, table, p,
  a, header, section, footer, button, label, input)
import Html.Attributes exposing (class, type_, value)
import Html.Events exposing (onClick, onInput)
import Json.Encode as Encode

import Common exposing (handleError, emptyToNothing, bulmaButton,
  bulmaClassButton, bulmaClassDisabledButton, bulmaTextInput)
        ...
        , section [ class "modal-card-body" ]
          [ div [ class "columns" ]
            [ div [ class "column", class "is-one-third" ]
              [ bulmaTextInput "Name"
                (\n -> TextInput { test | name = n }) test.name ]
            , div [ class "column" ]
              [ bulmaTextInput "Description"
                (\n -> TextInput { test | description = n }) test.description ]
            ]
          , div [ class "columns" ]
            [ div [ class "column" ]
              [ bulmaTextInput "Base Image"
                (\n -> TextInput { test | baseImage = n }) test.baseImage 
              , bulmaTextInput "Prompt"
                (\n -> TextInput { test | prompt = n }) test.prompt
              ]
            , div [ class "column" ]
              ...
              , bulmaTextInput "Command"
                (\n -> TextInput { test | command = n }) test.command
              ]
            , div [ class "column" ]
...
rowControls test =
  div [ class "field", class "is-grouped" ]
    ...
    , case test.jobs of
      ...
      _  -> bulmaClassDisabledButton "Delete" "is-danger"
    ]
...
getTests =
  Http.get
    { url = "/test"
    , expect = Http.expectJson GotTests testsDecoder
    }

testsDecoder : Decoder (List Test)
testsDecoder =
  list (Decode.succeed Test
    |> required "id" int
